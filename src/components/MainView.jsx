  ...
  return (
    <div>
      <nav class="bg-blue-900 p-4">
        ...
        <Link to="/info" class="text-white px-4">
          Información del Producto
        </Link>
        <Link to="/contact" class="text-white px-4">
          Contacto
        </Link>
      </nav>
          ...
          <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8 ">
            <div class="sm:max-w-lg ">
              <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl pl-3  border-solid border-yellow-700 rounded-md">
                ¡Toma{" "}
                <span class="pl-3 pt-2 pr-3 pb-1.5 rounded-md bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-blue-950">
                  Lubridol
                </span>{" "}
                y muevete sin dolor!
              </h1>
